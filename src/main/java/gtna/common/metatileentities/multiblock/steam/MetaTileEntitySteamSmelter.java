package gtna.common.metatileentities.multiblock.steam;
...
public class MetaTileEntitySteamSmelter extends RecipeMapSteamMultiblockController {
    ...
    public MetaTileEntitySteamSmelter(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntitySteamSmelter(metaTileEntityId);
    }
